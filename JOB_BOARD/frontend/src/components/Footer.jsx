        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <span className="text-2xl font-bold text-blue-400">JobBoard</span>
            </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/explore-jobs" className="text-gray-300 hover:text-blue-400 text-sm transition-colors">
                  Browse Jobs
                </Link>
              </li>
              <li>
                <Link to="/create-job" className="text-gray-300 hover:text-blue-400 text-sm transition-colors">
                  Post a Job
                </Link>
              </li>
              <li>
